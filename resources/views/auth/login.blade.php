    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-full lg:w-1/2 relative flex justify-center items-center">
            <div class="max-w-[480px] p-5 md:p-10">
                <h2 class="font-bold text-3xl mb-3">Admin Portal</h2>
                <p class="mb-7">Sign in to access the administrative dashboard</p>
                <form class="space-y-5" method="POST" action="{{ route('login') }}">
                    @csrf
                    <div>
                        <label for="email">Email</label>
                        <input name="email" value="{{ old('email') }}" id="email" type="email" class="form-input" placeholder="Enter Email" />
                    </div>
                    <div>
