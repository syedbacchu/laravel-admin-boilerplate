<x-layout.default>
    ...
    <div class="panel mt-6">
        ...
        <div>
            <form
                method="POST"
                action="{{ $function_type == 'create' ? route('featureCategory.store') : route('featureCategory.update', $item->id) }}"
            ...
            >
                ...
                <div class="mb-4">
                    ...
                    <div
                        x-data="featureCategoryImage('{{ $item->image ?? '' }}')"
                        class="space-y-2"
                    >
                        <button
                            type="button"
                            x-on:click="$dispatch('open-file-manager', { callback: 'featureCategoryImageSelected' })"
    ...
    <script>
        function featureCategoryImage(existingImage = '') {
            return {
                image: existingImage,
                preview: existingImage ? existingImage : '',
                init() {
                    window.addEventListener('featureCategoryImageSelected', (e) => {
