...
<div class="mt-8 bg-white shadow-xl rounded-2xl p-6 border border-gray-100">
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
        <h5 class="text-2xl font-bold text-gray-800">{{ $pageTitle ?? __('Product Feature List') }}</h5>
    ...
    <div class="overflow-x-auto">
        <x-common.datatable
            id="itemsTable"
            ajax="{{ route('product.feature.list') }}"
            :columns="[
                ['data' => 'title', 'name' => 'title', 'title' => 'Title'],
                ['data' => 'slug', 'name' => 'slug', 'title' => 'Slug'],
                ['data' => 'sub_title', 'name' => 'sub_title', 'title' => 'Sub Title'],
                ['data' => 'image', 'name' => 'image', 'title' => 'Image', 'orderable' => false, 'searchable' => false],
                ['data' => 'sort_order', 'name' => 'sort_order', 'title' => 'Sort'],
                ['data' => 'status_toggle', 'name' => 'status', 'title' => 'Status', 'orderable' => false, 'searchable' => false],
