<x-layout.default>
    ...
    <form
        id="package-form"
        method="POST"
        action="{{ $function_type == 'create' ? route('package.store') : route('package.update', $item->id) }}"
        class="mt-4"
    >
        @csrf
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-4">
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('package.list') }}" class="btn btn-outline-primary">{{ __('Back') }}</a>
                <button type="submit" class="btn btn-primary">{{ $function_type == 'create' ? __('Save Package') : __('Update Package') }}</button>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
            <div class="xl:col-span-2 space-y-6">
                <div class="panel !p-0 overflow-hidden border border-[#e0e6ed] dark:border-[#1b2e4b]">
                    <div class="px-4 py-3 border-b border-[#e0e6ed] dark:border-[#1b2e4b] bg-[#fafafa] dark:bg-[#0b1320]">
                        <h3 class="font-semibold text-base">{{ __('Package Information') }}</h3>
                    </div>
                ...
                {{-- Package Features --}}
                @php
                    $features = old('package_feature', $item->package_feature ?? []);
                ...
                <div class="panel !p-0 overflow-hidden border border-[#e0e6ed] dark:border-[#1b2e4b]">
                    <div class="px-4 py-3 border-b border-[#e0e6ed] dark:border-[#1b2e4b] bg-[#fafafa] dark:bg-[#0b1320] flex items-center justify-between">
                    ...
                    <div class="p-6">
                        ...
                        <div id="feature-wrapper">
                            ...
                            @foreach($features as $index => $feature)
                                ...
                                <div class="feature-item border rounded-xl p-4 mb-4">

                                <div class="flex gap-4 items-end">

                                    <div class="flex-1">
                                        <label class="block mb-2 font-medium">Feature</label>

                                        <input
                                            type="text"
                                            name="package_feature[{{ $index }}][content]"
                                    ...
                                    <div class="w-32">
                                        ...
                                        <input
                                            type="number"
                                            name="package_feature[{{ $index }}][sort_order]"
                                            value="{{ $feature['sort_order'] ?? $index }}"
                                            class="form-input w-full"
                                        >
                                    </div>
                                    ...
                                    <button
                                        type="button"
                                        class="btn btn-danger remove-feature h-[42px]"
                                    >
                                        ✕
                                    </button>
            ...
            <div class="space-y-6 xl:sticky xl:top-20 self-start">
                ...
                <div class="panel !p-0 overflow-hidden border border-[#e0e6ed] dark:border-[#1b2e4b]">
                    ...
                    <div class="p-4 space-y-4">
                        <div x-data="fileManager('{{ $item->thumbnail ?? old('thumbnail', '') }}', 'package_thumbnail')" class="space-y-2">
                        ...
                        <div x-data="fileManager('{{ $item->image ?? old('image', '') }}', 'package_image')" class="space-y-2">
                ...
                <div class="panel !p-0 overflow-hidden border border-[#e0e6ed] dark:border-[#1b2e4b]">
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        <div x-data="fileManager('{{ $item->meta_image ?? old('meta_image', '') }}', 'package_meta_image')" class="space-y-2">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.getElementById('add-feature').addEventListener('click', function () {
                ...
                let html = `
                    <div class="feature-item border rounded-lg p-4 mb-4">
                        ...
                        <div class="flex items-end gap-4">
                            ...
                            <div style="flex:1;">
                                ...
                                <input
                                    type="text"
                                    name="package_feature[${featureIndex}][content]"
                                    class="form-input w-full"
                                    placeholder="Enter Feature"
                                >
                            </div>
                            ...
                            <div style="width:140px;">
                                ...
                                <input
                                    type="number"
                                    name="package_feature[${featureIndex}][sort_order]"
                                    value="${featureIndex}"
                                    class="form-input w-full"
                                >
                            </div>
