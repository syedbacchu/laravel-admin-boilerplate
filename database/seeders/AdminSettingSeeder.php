...
class AdminSettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        AdminSettings::firstOrCreate(['slug' => 'logo'],['group' => enum(SettingGroupEnum::SETTING_GROUP_GENERAL),'value' => '']);
        AdminSettings::firstOrCreate(['slug' => 'login_logo'],['group' => enum(SettingGroupEnum::SETTING_GROUP_GENERAL),'value' => '']);
        AdminSettings::firstOrCreate(['slug' => 'login_sidebar_image'],['group' => enum(SettingGroupEnum::SETTING_GROUP_GENERAL),'value' => '']);
        AdminSettings::firstOrCreate(['slug' => 'favicon'], ['group' => enum(SettingGroupEnum::SETTING_GROUP_GENERAL),'value' => '']);
